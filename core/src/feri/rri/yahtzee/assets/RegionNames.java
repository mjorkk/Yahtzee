...
public class RegionNames {
    ...
    public static final String DICE_3 = "dice-3";
    ...
    public static final String SHUFFLE_1 = "shuffle-1";
    public static final String SHUFFLE_2 = "shuffle-2";
    public static final String SHUFFLE_3 = "shuffle-3";
    public static final String SHUFFLE_4 = "shuffle-4";
    public static final String SHUFFLE_5 = "shuffle-5";
    public static final String SHUFFLE_6 = "shuffle-6";
